...

{
	...
	{
		wp_enqueue_style($this->plugin_name, plugin_dir_url(__FILE__) . 'css/belocalendar-admin.css', array() , $this->version, 'all');
	}

	function enqueue_scripts()
	{
		wp_enqueue_script($this->plugin_name, plugin_dir_url(__FILE__) . 'js/belocalendar-admin.js', array() , $this->version, false);
	}
}